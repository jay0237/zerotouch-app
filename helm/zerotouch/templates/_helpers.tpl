...
helm.sh/chart: {{ include "zerotouch.chart" . }}
...
*/}}
{{- define "zerotouch.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "zerotouch.fullname" .) .Values.serviceAccount.name }}
{{- else }}
